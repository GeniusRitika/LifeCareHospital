<?php
        ...
        $sql = "SELECT * FROM admission ORDER BY date ASC, name ASC";
...
<head>
    <meta charset="UTF-8">
    <title>View Admitted Patient</title>
...
<body>
        ...
        <br><br>
    <section>
        <h1>Admitted Patient Information</h1>
        <!-- TABLE CONSTRUCTION-->
        <table>
            <tr>
                <th>Patient Name</th>
                ...
                <th>Problem</th>
                <th>BedType</th>
                <th>Date of Admitting to the hospital</th>
            </tr>
