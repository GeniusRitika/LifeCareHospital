...
<body>
        ...
        <div class="container">
        <h1>Appointment With Allopathic Doctor</h1>
        <form action="appointment.php" method="POST">
            <input type="hidden" name="dCategory" id="dCategory" value="Allopathic" readonly>
            <div class="form-group">
                <label for="DoctorName">Doctor's Name:</label>
                <br>
                <select name="DoctorName" class="form-control">
                <option value="Dr. Abhijeet Das Gupta">Dr. Abhijeet Das Gupta</option>
                <option value="Dr. Rashmi Desai">Dr. Rashmi Desai</option>
                <option value="Dr. Dhiraj Patel">Dr. Dhiraj Patel</option>
                </select>
            </div>
            <div class="form-group">
