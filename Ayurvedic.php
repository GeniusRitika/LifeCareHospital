...
<body>
        ...
        <div class="container">
        <h1>Appointment With Ayurvedic Doctor</h1>
        <form action="appointment.php" method="POST">
            <input type="hidden" name="dCategory" id="dCategory" value="Ayurvedic" readonly>
            <div class="form-group">
                <label for="DoctorName">Doctor's Name:</label>
                <br>
                <select name="DoctorName" class="form-control">
                <option value="Dr. Akansha Khaitan">Dr. Akansha Khaitan</option>
                <option value="Dr. Subham Kedia">Dr. Subham Kedia</option>
                <option value="Dr. Sunidhi Chowhaan">Dr. Sunidhi Chowhaan</option>
                </select>
            </div>
            <div class="form-group">
