...
<body>
        ...
        <div class="container">
        <h1>Appointment With Orthopedic</h1>
        <form action="appointment.php" method="POST">
            <input type="hidden" name="dCategory" id="dCategory" value="Orthopedic" readonly>
            <div class="form-group">
                <label for="DoctorName">Doctor's Name:</label>
                <br>
                <select name="DoctorName" class="form-control">
                <option value="Dr. Sreya Ghosal">Dr. Sreya Ghosal</option>
                <option value="Dr. Ananya Kanjilal">Dr. Ananya Kanjilal</option>
                <option value="Dr. Souvik Chatterjee">Dr. Souvik Chatterjee</option>
                <option value="Dr. Tushar Singh Rajput">Dr. Tushar Singh Rajput</option>
                </select>
            </div>
            <div class="form-group">
