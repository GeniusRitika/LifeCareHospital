...
<body>
        ...
        <div class="container">
        <h1>Appointment With Homeopath Doctor</h1>
        <form action="appointment.php" method="POST">
            <input type="hidden" name="dCategory" id="dCategory" value="Homeopath" readonly>
            <div class="form-group">
                <label for="DoctorName">Doctor's Name:</label>
                <br>
                <select name="DoctorName" class="form-control">
                <option value="Dr. Jagannath Chatterjee">Dr. Jagannath Chatterjee</option>
                <option value="Dr. Abdul Kalam">Dr. Abdul Kalam</option>
                </select>
            </div>
            <div class="form-group">
