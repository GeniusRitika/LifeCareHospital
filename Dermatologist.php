...
<body>
        ...
        <div class="container">
        <h1>Appointment With Dermatologist</h1>
        <form action="appointment.php" method="POST">
            <input type="hidden" name="dCategory" id="dCategory" value="Dermatologist" readonly>
            <div class="form-group">
                <label for="DoctorName">Doctor's Name:</label>
                <br>
                <select name="DoctorName" class="form-control">
                <option value="Dr. Mohini Patel">Dr. Mohini Patel</option>
                <option value="Dr. Dhiral Gandhi">Dr. Dhiral Gandhi</option>
                </select>
            </div>
            <div class="form-group">
