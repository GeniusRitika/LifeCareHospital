...
<body>
        ...
        <div class="container">
        <h1>Appointment With Gynaecologist</h1>
        <form action="appointment.php" method="POST">
            <input type="hidden" name="dCategory" id="dCategory" value="Gynaecologist" readonly>
            <div class="form-group">
                <label for="DoctorName">Doctor's Name:</label>
                <br>
                <select name="DoctorName" class="form-control">
                <option value="Dr. Ankita Dey">Dr. Ankita Dey</option>
                <option value="Dr. Nisha Roy">Dr. Nisha Roy</option>
                </select>
            </div>
            <div class="form-group">
