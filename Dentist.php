...
<body>
        ...
        <div class="container">
        <h1>Appointment With Dentist</h1>
        <form action="appointment.php" method="POST">
            <input type="hidden" name="dCategory" id="dCategory" value="Dentist" readonly>
            <div class="form-group">
                <label for="DoctorName">Doctor's Name:</label>
                <br>
                <select name="DoctorName" class="form-control">
                <option value="Dr. Rishab Pant">Dr. Rishab Pant</option>
                <option value="Dr. Rohan Sharma">Dr. Rohan Sharma</option>
                <option value="Dr. Harshit Vyas">Dr. Harshit Vyas</option>
                <option value="Dr. Gauri Chowrasiya">Dr. Gauri Chowrasiya</option>
                </select>
            </div>
            <div class="form-group">
