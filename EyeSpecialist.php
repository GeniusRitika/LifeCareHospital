...
<body>
        ...
        <div class="container">
        <h1>Appointment With Eye Specialist</h1>
        <form action="appointment.php" method="POST">
            <input type="hidden" name="dCategory" id="dCategory" value="Eye Specialist" readonly>
            <div class="form-group">
                <label for="DoctorName">Doctor's Name:</label>
                <br>
                <select name="DoctorName" class="form-control">
                <option value="Dr. Yashmin Parekh">Dr. Yashmin Parekh</option>
                <option value="Dr. Pratik Joshi">Dr. Pratik Joshi</option>
                <option value="Dr. Suman Dey">Dr. Suman Dey</option>
                </select>
            </div>
            <div class="form-group">
