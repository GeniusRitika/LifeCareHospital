...
<body>
        ...
        <div class="container">
        <h1>Appointment With Immunologist</h1>
        <form action="appointment.php" method="POST">
            <input type="hidden" name="dCategory" id="dCategory" value="Immunologist" readonly>
            <div class="form-group">
                <label for="DoctorName">Doctor's Name:</label>
                <br>
                <select name="DoctorName" class="form-control">
                <option value="Dr. Tushar Jain">Dr. Tushar Jain</option>
                <option value="Dr. Subham Rai Adhikari">Dr. Subham Rai Adhikari</option>
                </select>
            </div>
            <div class="form-group">
