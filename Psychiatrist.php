...
<body>
        ...
        <div class="container">
        <h1>Appointment With Psychiatrist</h1>
        <form action="appointment.php" method="POST">
            <input type="hidden" name="dCategory" id="dCategory" value="Psychiatrist" readonly>
            <div class="form-group">
                <label for="DoctorName">Doctor's Name:</label>
                <br>
                <select name="DoctorName" class="form-control">
                <option value="Dr. Moumita Roy">Dr. Moumita Roy</option>
                <option value="Dr. Anup Soni">Dr. Anup Soni</option>
                </select>
            </div>
            <div class="form-group">
