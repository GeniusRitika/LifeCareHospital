...
<body>
        ...
        <div class="container">
        <h1>Appointment With ENT Specialist</h1>
        <form action="appointment.php" method="POST">
            <input type="hidden" name="dCategory" id="dCategory" value="ENT Specialist" readonly>
            <div class="form-group">
                <label for="DoctorName">Doctor's Name:</label>
                <br>
                <select name="DoctorName" class="form-control">
                <option value="Dr. Naresh Kedia">Dr. Naresh Kedia</option>
                <option value="Dr. Shivam Jaiswal">Dr. Shivam Jaiswal</option>
                <option value="Dr. Sudheshna Roy">Dr. Sudheshna Roy</option>
                <option value="Dr. Rahul Raj">Dr. Rahul Raj</option>
                </select>
            </div>
            <div class="form-group">
