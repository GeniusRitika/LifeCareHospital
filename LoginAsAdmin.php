...
<body>
    ...
    <div class="main-container" style="margin-top: 10%;">
            ...
            <div class="form-group">
                <input class="form-control" type="text" name="uid" placeholder="Enter your id">
            </div>
            <div class="form-group">
                <input class="form-control" type="text" name="securityCode" id="securityCode" placeholder="Enter your security code">
            </div>
            <div class="form-group">
